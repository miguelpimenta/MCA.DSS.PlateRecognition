from flask import Flask, request, jsonify, render_template, send_from_directory, url_for, abort, jsonify, redirect
...
# Flask Consulate https://github.com/vsudilov/flask-consulate

app = Flask(__name__)

app.config['UPLOAD_EXTENSIONS'] = ['.jpg', '.png', '.gif']
app.config['UPLOAD_PATH'] = 'uploads'
app.config['PLATE_RECOGNIZER_URL'] = os.environ['PLATE_RECOGNIZER_URL']
app.config['PLATE_RECOGNIZER_TOKEN'] = os.environ['PLATE_RECOGNIZER_TOKEN']
